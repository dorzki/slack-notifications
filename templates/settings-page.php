...
<div class="wrap">
	...
	<form action="options.php" method="post">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row">
					<label for="slack_webhook_endpoint"><?php esc_html_e( 'Webhooks Endpoint', 'dorzki-notifications-to-slack' ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label for="slack_channel_name"><?php esc_html_e( 'Channel Name', 'dorzki-notifications-to-slack' ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label for="slack_bot_username"><?php esc_html_e( 'Slack Bot Name', 'dorzki-notifications-to-slack' ); ?></label>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">
					<label for="slack_bot_image"><?php esc_html_e( 'Slack Bot Logo', 'dorzki-notifications-to-slack' ); ?></label>
				</th>
				<td>
			...
			<tr>
				...
				<td>
					<fieldset>
						...
						<!-- Future Post -->
						<label for="slack_notif_future_post">
							<input type="checkbox" name="slack_notif_future_post" id="slack_notif_future_post" value="1" <?php checked( $future_post, 1, true ); ?>> <?php esc_html_e( 'Post Scheduled', 'dorzki-notifications-to-slack' ); ?>
						</label>
						<br>
						<!-- /Future Post -->
						...
						<!-- Future Page -->
						<label for="slack_notif_future_page">
							<input type="checkbox" name="slack_notif_future_page" id="slack_notif_future_page" value="1" <?php checked( $future_page, 1, true ); ?>> <?php esc_html_e( 'Page Scheduled', 'dorzki-notifications-to-slack' ); ?>
						</label>
						<br>
						<!-- /Future Page -->
